...
void simd_mat_mul(double *A, double *B, double *C, int size) {
     ...
     *  Uncomment this block and set vec_width = 2 to experiment with SSE2.
     *
     *  for (int i = 0; i < size; i++) {
     *      for (int k = 0; k < size; k++) {
     ...
     *  Uncomment this block and set vec_width = 4 to experiment with AVX2.
     *
     *  for (int i = 0; i < size; i++) {
     *      for (int k = 0; k < size; k++) {
    ...
    /* ── 512-bit AVX-512 path (8 doubles per register) ──────────────────
     *  This is the path you must implement.
     *  vec_width = 8  (one __m512d holds 8 double-precision values)
     * ──────────────────────────────────────────────────────────────────*/
...
int main(int argc, char **argv) {
    ...
    printf("Reference (naive) multiplication ... done in %5ld ms\n", ref_ms);
